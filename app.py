...
replies_massa = [
    ...
    ImageSendMessage(original_content_url='https://hmifbot.herokuapp.com/images/Meme-1.png',
                     preview_image_url='https://hmifbot.herokuapp.com/images/Meme-1.png'),
    ImageSendMessage(original_content_url='https://hmifbot.herokuapp.com/images/Meme-2.png',
                     preview_image_url='https://hmifbot.herokuapp.com/images/Meme-2.png'),
]
